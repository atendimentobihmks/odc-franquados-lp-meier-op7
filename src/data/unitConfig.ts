...
export const UNITS_DATA: Record<string, UnitData> = {
  meier: {
    ...
    facebookUrl: 'https://web.facebook.com/odontocompanymeier/',
    croCl: 'CRO-RJ 44.095',
    address: {
      street: 'Rua Dias da Cruz',
      number: '147, Sobreloja',
      neighborhood: 'Méier',
      city: 'Rio de Janeiro',
      state: 'RJ',
      zipCode: '20720-010'
    ...
    clinicalDirector: {
      name: 'Dra. Francielly Soares de Macêdo',
      cro: 'CRO-RJ 44095',
    ...
    dentists: [
      {
        ...
        cro: 'CRO-RJ 44095',
        photoUrl: '/images/dentistas/dra-francielly-macedo.webp'
      }
    ],
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Excelente atendimento na OdontoCompany Méier! A clínica é muito bonita, os profissionais super atenciosos e o tratamento de implante foi super tranquilo.',
        treatment: 'Implante Dentário'
      },
      {
        name: 'Mariana Silveira',
        rating: 5,
        text: 'Coloquei meu aparelho na OdontoCompany Méier e já vejo muita diferença no meu sorriso. Facilidade no pagamento e equipe maravilhosa!',
        treatment: 'Ortodontia'
      },
      {
        name: 'Luciana Ramos',
        rating: 5,
        text: 'Fiz clareamento e limpeza preventiva na unidade. Atendimento pontual, ambiente muito limpo e profissionais que passam muita segurança. Recomendo a todos de Méier e Zona Norte e região.',
